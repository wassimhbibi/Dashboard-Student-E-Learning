    ...
    // Admin routes
    {
        ...
        children: [
            ...
            {path: 'apps', children: [
                ...
                {path: 'show_all_chapter' , component:ShowAllChapterComponent},
                {path: 'show_lessons', component:ShowLessonsComponent},
                {path: 'showLessonDisc' , component:ShowLessonDiscComponent},
                {path: 'show_test' , component:ShowTestComponent},
                {path: 'show-exercice', component:ShowExerciceComponent},
                {path: 'profil' , component:ProfilComponent},
                {path : 'payment' , component:PaymentComponent},
                {path: 'edit_profil' , component:EditProfilComponent},
                {path: 'chatt' , component:ChaaatComponent},
                {path: 'about' , component:AboutComponent},
                {path: 'partners' ,component:PartnersComponent },
                {path: 'contact',component:ContactComponent  },
                {path: 'metting',component:MettingComponent  },
                {path: 'show_answer',component:ShowanswerComponent},
                {path: 'certif',component:CertificateComponent},
                {path: 'historical',component:HistoricalComponent},
                {path: 'about_cours',component:AboutCoursComponent},
                {path: 'show_note',component:ShowNoteComponent},
                {path: 'chatmm',component:ChaaatComponent}
